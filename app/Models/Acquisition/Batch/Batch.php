...
class Batch extends Model implements DefaultQueryInterface
{
    ...
    {
        return static::query()->select('s.title_' . app()->getLocale() . ' as status', 'b.status as status_key', 'b.hesab_id as id', 'b.invoice_date',
            ...
            'b.titles_no as titles_no', 'b.doc_no as doc_no', 'b.contract_no', 'b.invoice_details', 'b.create_date as create_date', 'b.edit_date', 'b.cost',
